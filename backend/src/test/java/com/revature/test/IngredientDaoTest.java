...
public class IngredientDaoTest {
    ...
    void updateIngredientTest() {
        ...
        assertEquals(ingredient.getName(), updatedIngredient.getName(),
                () -> "The returned ingredient name doesn't match the expected name. Expected: " + ingredient.getName()
    ...
    void getAllIngredientsTest() {
        ...
        assertIterableEquals(ingredientList, ingredients,
                () -> "The returned ingredients don't match the expected ingredients. Expected: " + ingredientList
                        + " Actual: " + ingredients);
    }
    ...
    void getAndPageAllIngredientsTest() {
        ...
        Page<Ingredient> expectedIngredients = new Page<>(1, 2, ingredientList.size() / 2, ingredientList.size(),
    ...
    void searchIngredientsTest() {
        ...
        assertIterableEquals(expectedIngredients, ingredients,
                () -> "The returned ingredients don't match the expected ingredients. Expected: " + expectedIngredients
                        + " Actual: " + ingredients);
    }
