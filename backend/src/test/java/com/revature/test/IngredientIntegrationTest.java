...
public class IngredientIntegrationTest {
    ...
    void testGetIngredients() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals("[{\"id\":1,\"name\":\"carrot\"},{\"id\":2,\"name\":\"potato\"},{\"id\":3,\"name\":\"tomato\"},{\"id\":4,\"name\":\"lemon\"},{\"id\":5,\"name\":\"rice\"},{\"id\":6,\"name\":\"stone\"}]", client.get("/ingredients").body().string());
        });
    }
    ...
    void testPageIngredients() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals("{\"pageNumber\":1,\"pageSize\":2,\"totalPages\":3,\"totalElements\":6,\"items\":[{\"id\":1,\"name\":\"carrot\"},{\"id\":2,\"name\":\"potato\"}]}", client.get("/ingredients?page=1&pageSize=2").body().string());
        });
    }
    ...
    void testGetIngredientsByTerm() {
        JavalinTest.test(app, (server, client) -> {
            ...
            assertEquals("[{\"id\":2,\"name\":\"potato\"},{\"id\":3,\"name\":\"tomato\"},{\"id\":6,\"name\":\"stone\"}]", client.get("/ingredients?term=to").body().string());
        });
    }
    ...
    void testGetIngredientsByTermSorted() {
        JavalinTest.test(app, (server, client) -> {
            assertEquals(200, client.get("/ingredients?term=to&sortBy=name&sortDirection=desc&page=1&pageSize=3").code());
            assertEquals("{\"pageNumber\":1,\"pageSize\":3,\"totalPages\":1,\"totalElements\":3,\"items\":[{\"id\":3,\"name\":\"tomato\"},{\"id\":6,\"name\":\"stone\"},{\"id\":2,\"name\":\"potato\"}]}", client.get("/ingredients?term=to&sortBy=name&sortDirection=desc&page=1&pageSize=3").body().string());
        });
    }
